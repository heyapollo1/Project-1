...
public class RubyItem : BaseItem
{
    ...
    public RubyItem(Sprite rubyIcon, Rarity rarity) 
        : base("Ruby Item", rubyIcon, 50, ItemType.Inventory, rarity, null, ClassTags,
            new RubyItemEffect(50f))
    {
    ...
    {
        return description = $"Deal {damageMultiplier}% bonus damage when under half health.";
    }
}
...
/*public class RubyItem : BaseItem
   {
       ...
       public RubyItem(Sprite rubyIcon, Rarity rarity) 
           : base("Ruby Item", rubyIcon, 50, ItemType.Inventory, rarity, rarityModifiers[rarity], ClassTags,
