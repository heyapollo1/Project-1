...
public class SpawnManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        EventManager.Instance.StartListening("StageComplete", StageEnded);
        EventManager.Instance.StartListening("UpdateBossWave", UpdateBossWaveSettings);

        poolManager = EnemyPoolManager.Instance;
        player = PersistentManager.Instance.playerInstance?.transform;
    ...
    public void OnDestroy()
    {
        ...
        EventManager.Instance.StopListening("StageComplete", StageEnded);
        EventManager.Instance.StartListening("UpdateBossWave", UpdateBossWaveSettings);
    }
